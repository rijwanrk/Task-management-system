...
const API_BASE = 'https://task-management-system-backend-cceq.onrender.com/api/tasks';
      ...
      <div className="bg-white border border-blue-100 rounded-xl max-w-md w-full shadow-lg p-6 relative animate-fadeIn">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-gradient-to-r from-fuchsia-500 to-blue-600 text-white font-medium py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 disabled:opacity-50 hover:shadow-md transition-all duration-200"
          >
