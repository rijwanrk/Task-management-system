...
const Login = ({ onSubmit, onSwitchMode }) => {
  ...
  const url = "https://task-management-system-backend-cceq.onrender.com"
  ...
  return (
    <div className="max-w-md w-full bg-white shadow-lg border border-blue-100 rounded-xl p-8">
      ...
      <div className="mb-6 text-center">
        ...
        <p className="text-gray-500 text-sm mt-1">Sign in to continue to Task management system</p>
      </div>
